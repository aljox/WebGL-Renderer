...
function test(renderEngine) {
  ...
  let rotation = [MathExt.degreeToRadians(40), MathExt.degreeToRadians(25), MathExt.degreeToRadians(325)];
  let scale = [1, 1, 1];
  ...
  let near = 400;
  let far = -400;
  let orthographic = Matrix44f.initOrtographich(left, right, bottom, top, near, far);
  ...
  let matrix = Matrix44f.mulArray([scalE, rotate, translate, orthographic]);
